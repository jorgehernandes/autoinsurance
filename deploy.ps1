...
#DeployIIS -Origem "C:\Program Files (x86)\Jenkins\workspace\commit\AutoInsurance\bin" -Destino "C:\N3\WEB_IIS" -Ambiente "QA" -Projeto "AutoInsurance"